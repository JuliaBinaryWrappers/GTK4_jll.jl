# `GTK4_jll.jl` (v4.18.6+0)

[![deps](https://juliahub.com/docs/GTK4_jll/deps.svg)](https://juliahub.com/ui/Packages/General/GTK4_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/479e01f0e802a203ec06d632ab378ff5c54f40fb/G/GTK4/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://download.gnome.org/sources/gtk/4.18/gtk-4.18.6.tar.xz (SHA256 checksum: `e1817c650ddc3261f9a8345b3b22a26a5d80af154630dedc03cc7becefffd0fa`)
