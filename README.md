...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b69e2afc02323258cdc873e8b8b1a8fc1a465097/G/GTK4/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://download.gnome.org/sources/gtk/4.10/gtk-4.10.4.tar.xz (SHA256 checksum: `7725400482e0685e28265e226c62847f4e73cfca9e9b416ac5838207f5377a24`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/b69e2afc02323258cdc873e8b8b1a8fc1a465097/G/GTK4/bundled)
